...
class InvalidUserEmailException(override val message: String) : RuntimeException()
...
class FailedLoginAttemptException(override val message: String) : RuntimeException()
